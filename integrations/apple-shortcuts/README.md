...
No Shortcut action editing is required. Valid import profiles are `best`, `1080p`, `720p`, `audio-mp3`, `audio-m4a`, and `ask`. The distributed file contains placeholders only and no real endpoint or credentials.
